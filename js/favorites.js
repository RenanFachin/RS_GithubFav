...
export class FavoritesView extends Favorites {
    ...
    noFavoritesFunction(){
        ...
        // se o não tiver nada no entries
        this.entries.length === 0 ? 
        // remove a classe sr only
        document.querySelector('.noFavorites').classList.remove('sr-only') : 
        // adiciona a classe sr only
        document.querySelector('.noFavorites').classList.add('sr-only')
    }

    update(){
        this.noFavoritesFunction()
        this.removeAllTr()
